...
- [x] **Hadji Murat novel-dive shipped** (2026-06-09) — 3rd flagship novel-dive (`docs/research/1896-1904-hadji-murat/`), from the 2026-06-08 scope handoff; committed, **not pushed** (Johan pushes). The heaviest genesis layer yet (the 82-item «Список источников» + the Stasov / Grand-Duke-Nikolai-Mikhailovich / Tiflis archive network; 2166 manuscript sheets; ten redactions); posthumous 1912 censorship (Belgard cut the Nicholas-I chapter >10pp→4½pp + the aul-burning, Chertkov restored it in Berlin); marquee finding = the *What Is Art?* contradiction was **lived, not reconciled** (`extends` Simmons/Herman/biographical). First dive to apply wiki-schema **v1.4** (`character`+`group`). verify_quotes 34/34; opus verifier CLEAN (0 blocking, 5 minor — 2 addressed). Next fiction in the queue: Father Sergius, Master and Man, The Power of Darkness.
