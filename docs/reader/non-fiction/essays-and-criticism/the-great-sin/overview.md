...
An essay of 1905. Its Russian title is «Великий грех» (the great sin); the English
translation published the same year was titled *A Great Iniquity*. Source text:
...
It was written during the [[1905 Revolution]], when liberal, social-democrat and
revolutionary alike were certain the answer was political. The essay's answer is
older and simpler: a man is born onto the earth and then denied the right to use
it, and no constitution touches that. Two separate pieces — one against the
intelligentsia who set themselves up as the people's defenders, «Народные
заступники» (The People's Defenders), and one on [[Henry George]] — were fused
...
Alexander II's decree but because private men came to feel its sin, so the land
will be freed when those who profit from holding it wake to what they do.

Near the end the whole argument rests on one old peasant at Tula station who,
hearing an article on the "agrarian question" read aloud, follows none of the
jargon and grasps only that «захват земли неработающими людьми есть великий грех»
(the seizure of land by those who do not work it is a great sin) — and crosses
himself. The indictment then closes on the writer's own class: «мы, русские
паразиты» (we, Russian parasites), fed by the labour of the people, will
understand our sin.

## The title

«Великий грех» (the great sin) is the essay's own phrase, repeated in the text —
in the narration and in the peasant's mouth. The 1905 English translation, by
Chertkov and Mayo, appeared in *The Times* of London as *A Great Iniquity*, and
the shift is not small. "Iniquity" carries the wrong out of religion and into law
and economy; "a" makes it one wrong among many where "the" made it the one. The
English softens just what the essay means to press. Who settled on that title is a
...
One cut is the only one whose reason is on record. In proof, the essay's whole opening — its introduction as first drafted — was given a title of Chertkov's own, «Необходимый переворот» (A Necessary Revolution), and published on its own in the émigré paper *Свободное слово*. Within that piece a single paragraph was lifted out of the introduction and set apart at its end, under an editorial note. The paragraph: «жизнь народа слагается не вследствие внешних форм… а внутренней деятельностью отдельных личностей» (the life of a people is shaped not by the outward forms imposed on it from without, but by the inner activity of individual persons). His reason, in a letter that July: it «стоит в противоречии со всем предыдущим» (stands in contradiction with all that precedes it) — against the essay's insistence that the outward forms of land-holding must change. So the two things the essay holds together — that the real change is inward, and that the outward arrangement must go — were quietly parted, and the inward-only half set outside the essay.
...
is praised as elaborated "to such a degree of perfection" that no better, more
just or more peaceful one could be devised — and the real remedy is held, in the
