---
title: timelinegraph — prototype 10 design (split-view: graph + vertical timeline + stub panel)
date: 2026-05-04
status: approved (brainstorming complete; awaiting prototype implementation)
owner: Johan
